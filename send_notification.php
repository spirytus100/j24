<?php
    ...
    echo "Got contact mail address<br>";

    echo "Fetching tasks...<br>";
    $result = $conn->query("SELECT * FROM tasks WHERE finished = 0 AND scheduled_time > CURRENT_DATE AND scheduled_time < CURRENT_DATE + INTERVAL 2 DAY");
